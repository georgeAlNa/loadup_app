...
class _$SuccessImpl<T> implements Success<T> {
  const _$SuccessImpl(this.signupResponse);
  ...
  @override
  String toString() {
    return 'SignupState<$T>.success(signupResponse: $signupResponse)';
  }
...
abstract class Success<T> implements SignupState<T> {
  const factory Success(final SignupResponse signupResponse) = _$SuccessImpl<T>;
